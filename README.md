...
- ### System Requirements
  ...
  + ### 실험 1: BLE 조명 장치 공격
    ...
    3) bleak를 통해 A-PC가 조명과 연결 유지, 연결이 끊기면 B-PC가 즉시 재연결되는 무결성 취약점 실험 수행<br><br>    
  ...
  + ### 실험 2: AR 수트 진동 센서 공격
    ...
    5) 개별 센서 제어 및 세기 조절 가능성을 검증<br><br>
...
## Conclusion
  - ### 실험 1: BLE 조명 장치 공격 결과<br>
    ...
    + **BLE Write 무결성 취약점 존재, 기기 인증 체계 부재로 공격자 개입이 용이함**<br><br>
